...
// primeira div é a tela geral 
// segunda div é o primeiro lado da tela onde vai as info de login 
    ...
    <div className="container">
      <div className="content first-content">
        <div className="first-column"> 
          ...
          <p className="descricao description-primary">Alguma idéia?</p>
          <p className="descricao description-primary">Vamos escrever algo aqui</p>
        ...
        <div className="second-column">
          ...
          <div className="content second-content">
            ...
            <div className="first-column"> 
              ...
              <p className="descricao description-primary">A pensar no que escrever</p>
              <p className="descricao description-primary">Aqui também, alguma idéia?</p>
